...
namespace Rackspace.Cloud.Server.Agent.Specs {
    ...
    public class JsonSpec {
        ...
        {
            const string stringWrong = "{\"mac\":\"40:40:92:9e:44:48\",\"dns\":[\"72.3.128.240\",\"72.3.128.241\"],\"label\":\"public\",\"ips\":[{\"ip\":\"98.129.220.138\",\"netmask\":\"255.255.255.0\"}],\"gateway\":\"98.129.220.1\",\"ip6s\":[{\"ip\":\"2001:0DB8::0\",\"netmask\":\"32\"}],\"gateway_v6\":\"fe80::def\",\"slice\":74532}";
            const string stringCorrt = "{\"mac\":\"40:40:92:9e:44:48\",\"dns\":[\"72.3.128.240\",\"72.3.128.241\"],\"label\":\"public\",\"ips\":[{\"ip\":\"98.129.220.138\",\"netmask\":\"255.255.255.0\"}],\"gateway\":\"98.129.220.1\",\"ip6s\":[{\"ip\":\"2001:0DB8::0\",\"netmask\":\"32\"}],\"gateway_v6\":\"fe80::def\"}";
            ...
            Assert.That(serialized, Is.EqualTo("{\"mac\":\"40:40:92:9e:44:48\",\"dns\":[\"72.3.128.240\",\"72.3.128.241\"],\"label\":\"public\",\"ips\":[{\"ip\":\"98.129.220.138\",\"netmask\":\"255.255.255.0\",\"enabled\":\"1\"}],\"ip6s\":[{\"ip\":\"2001:0DB8::0\",\"netmask\":\"32\",\"enabled\":\"0\"}],\"gateway\":\"98.129.220.1\",\"gateway_v6\":\"fe80::def\",\"routes\":null}"));
